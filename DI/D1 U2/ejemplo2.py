...
# Luego importamos el módulo de gtk y el gtk.glade, este ultimo que nos sirve para poder llamar/utilizar al archivo de glade
import gtk
import gtk.glade
...
# script habría que indicarle la ruta completa en donde se encuentra
		self.gladefile = "GladeEjemplo.glade"
		builder = gtk.Builder()
		builder.add_from_file(self.gladefile)
# Creamos un pequeño diccionario que contiene las señales definidas en
# glade y su respectivo método (o llamada)
		signals = { "on_entry1_activate" : self.on_button1_clicked,"on_button1_clicked" : self.on_button1_clicked,"gtk_main_quit" : gtk.main_quit }
...
# Para terminar iniciamos programa
